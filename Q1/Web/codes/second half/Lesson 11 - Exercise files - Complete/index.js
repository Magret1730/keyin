...
function ShowInv() {
  ...
  // Can we set the retail price so it always ends in .95
  RetailPrice = Math.ceil(RetailPrice) - 0.05;
  ...
  let Results =
    ...
    "<tr>" +
    "<td class='lefttext'>Retail Price:</td>" +
    "<td class = 'righttext'>" +
    cur2Format.format(RetailPrice) +
    "</td>" +
    "</tr>" +
    "<tr>" +
    "<td class='lefttext'>Sale Price (10% off):</td>" +
    "<td class = 'righttext'>" +
    cur2Format.format(Off10) +
    "</td>" +
    "</tr>" +
    "<tr>" +
    "<td class='lefttext'>Sale Price (25% off):</td>" +
    "<td class = 'righttext'>" +
    cur2Format.format(Off25) +
    "</td>" +
    "</tr>" +
    "<tr>" +
    "<td class='lefttext'>Sale Price (33% off):</td>" +
    "<td class = 'righttext'>" +
    cur2Format.format(Off33) +
    "</td>" +
    "</tr>" +
    "<tr>" +
    "<td class='lefttext'>Sale Price (50% off):</td>" +
    "<td class = 'righttext'>" +
    cur2Format.format(Off50) +
    "</td>" +
    "</tr>" +
    "</table>";

  document.getElementById("ShowInv").innerHTML = Results;
}
